...
class LineChartApp(tk.Tk):
    def __init__(self):
        ...
        # Set canvas dimensions for temperature and chart
        ...
        # Set temperature thresholds and normal range
        self.low_value = 18
        self.high_value = 27
        ...
        self.update_button = ttk.Button(
            self.input_frame, text="Go", command=self.draw_chart
        )
    ...
    def draw_chart(self):
        ...
        self.canvas.create_text(
            400, 5, text=f"Data range: {data_range[0]}-{data_range[1]}", anchor=tk.N
        )
